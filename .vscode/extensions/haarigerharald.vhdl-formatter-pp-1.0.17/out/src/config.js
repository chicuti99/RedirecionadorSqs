...
exports.getConfig = exports.getExtSettings = exports.getSettings = exports.CONFIGURATION_INDENTATION = exports.CONFIGURATION_CASE_TYPENAME = exports.CONFIGURATION_CASE_KEYWORD = exports.CONFIGURATION_NEWLINE_AFTER_GENERIC = exports.CONFIGURATION_NEWLINE_AFTER_ELSE = exports.CONFIGURATION_NEWLINE_AFTER_SEMICOLON = exports.CONFIGURATION_NEWLINE_AFTER_THEN = exports.CONFIGURATION_NEWLINE_AFTER_PORT = exports.CONFIGURATION_ALIGN_SIGN_MODE = exports.CONFIGURATION_ALIGN_COMMENTS = exports.CONFIGURATION_ALIGN_GENERIC_SIGN = exports.CONFIGURATION_ALIGN_PROCEDURE_SIGN = exports.CONFIGURATION_ALIGN_FUNCTION_SIGN = exports.CONFIGURATION_ALIGN_PORT_SIGN = exports.CONFIGURATION_ALIGN_ALL_SIGN = exports.CONFIGURATION_CHECK_ALIAS = exports.CONFIGURATION_REMOVE_REPORTS = exports.CONFIGURATION_REMOVE_BLANK_LINES = exports.CONFIGURATION_REMOVE_COMMENTS = exports.CONFIGURATION_INSERT_FINAL_NEW_LINE = exports.CONFIGURATION_KEY = void 0;
...
exports.CONFIGURATION_REMOVE_COMMENTS = "remove.comments"; // Boolean
exports.CONFIGURATION_REMOVE_BLANK_LINES = "remove.blankLines"; // Boolean
exports.CONFIGURATION_REMOVE_REPORTS = "remove.reports"; // Boolean
...
exports.CONFIGURATION_ALIGN_COMMENTS = "align.comments"; // Boolean
...
exports.CONFIGURATION_INDENTATION = "indentation"; // String
var AlignMode;
(function (AlignMode) {
...
function getIndentation(options) {
    if (vscode.workspace.getConfiguration(exports.CONFIGURATION_KEY, null).has(exports.CONFIGURATION_INDENTATION)) {
        return vscode.workspace.getConfiguration(exports.CONFIGURATION_KEY, null).get(exports.CONFIGURATION_INDENTATION);
    }
...
function getConfig(options) {
    ...
    var alignComments = getExtSettings(exports.CONFIGURATION_ALIGN_COMMENTS, false);
    ...
    var alignSettings = new VHDLFormatter.signAlignSettings(signAlignKeywords.length > 0, alignAllSign, signAlignMode, signAlignKeywords, alignComments);
